...
```toml
[dependencies]
mqtt-protocol-core = { version = "0.7.9", default-features = false }
```
...
[dependencies]
mqtt-protocol-core = { version = "0.7.9", default-features = false, features = ["tracing"] }

# Use with std but without tracing
[dependencies]
mqtt-protocol-core = { version = "0.7.9", default-features = false, features = ["std"] }

# Full-featured (std + tracing)
[dependencies]
mqtt-protocol-core = { version = "0.7.9", features = ["tracing"] }
```
...
[dependencies]
mqtt-protocol-core = { version = "0.7.9", features = ["sso-lv10"] }

# Combine with other features
[dependencies]
mqtt-protocol-core = { version = "0.7.9", features = ["std", "sso-lv20", "tracing"] }
```
